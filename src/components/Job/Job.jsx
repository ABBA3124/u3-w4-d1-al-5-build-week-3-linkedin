...
const Job = () => {
  ...
  const searchByCompany = (company) => {
    fetchJobs(`https://strive-benchmark.herokuapp.com/api/jobs?company=${company}`)
  }

  const searchByCategory = (category) => {
    fetchJobs(`https://strive-benchmark.herokuapp.com/api/jobs?category=${category}&limit=10`)
  }
            ...
            <Row className="p-4">
              <Col md={4}>
                <div className="rounded-4 p-4 bg-light text-start job">
                  <div className="d-flex align-items-center flex-row ">
                    ...
                    <span className="fw-bold mx-1 my-1">Le mie offerte di lavoro</span>
                  </div>
                  <div className="d-flex align-items-center flex-row">
                  ...
                  <div className="d-flex align-items-center flex-row">
                    ...
                    <span className="fw-bold mx-1 my-1">Valutazione delle competenze</span>
                  </div>
                  <div className="d-flex align-items-center flex-row">
                    <i className="bi bi-youtube me-2"></i>
                    <span className="fw-bold mx-1 my-1">Indicazioni per chi cerca lavoro</span>
                  </div>
                </div>
              </Col>
              ...
              <Col md={8}>
                <div className="rounded-4 p-4 bg-light text-start">
                  <p className="fw-bold fs-5">Le principali offerte di lavoro per te</p>
                ...
                <div className="rounded-4 p-4 bg-light text-start mt-3 premium-job">
                  <p className=" mb-0 title-job">Offerte di lavoro per cui rientri fra i migliori candidati</p>
                  ...
                  <div className="d-flex align-items-start premium-job-2">
                    <img src={profileData?.image} alt="img" width={50} className="rounded-5 mt-2 mx-4" />

                    <div>
                      <span className="fw-bold">
                        Vedi l&apos;elenco completo delle offerte di lavoro per cui saresti fra i migliori candidati
                      </span>
                      <p className="text-secondary">{profileData?.name} e milioni di altri utenti usano Premium</p>
                      <Button className="bg-warning rounded-5 text-dark fw-bold border-0 mb-3">
                        Prova Premium per 0 EUR
                      </Button>
                      <p className="text-secondary">
                        Prova gratuita di 1 mese. Ti invieremo un promemoria 7 giorni prima della fine del periodo di
                        prova.
                      </p>
                    </div>
                  </div>
